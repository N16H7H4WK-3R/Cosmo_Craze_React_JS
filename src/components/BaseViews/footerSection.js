...
export default function Footer() {
    return (
        <>
            <footer className="bg-blue-100/80 font-sans dark:bg-gray-900" style={{ borderTop: "1px solid gray" }}>
                <div className="container px-6 py-12 mx-auto">
                    ...
                    <div className="flex justify-between">
                        <p className="font-sans text-white pt-8 md:text-left md:text-sm" style={{ userSelect: "none" }}>© 2023 Cosmo_Craze Inc.</p>
                        <p className="font-sans text-white pt-8 md:text-right md:text-sm" style={{ userSelect: "none" }}>Developed by <a href="https://github.com/N16H7H4WK-3R" target='blank' className="hover:text-blue-500" >N16H7H4WK-3R</a> </p>
                    </div>
                </div>
            </footer>
        </>
